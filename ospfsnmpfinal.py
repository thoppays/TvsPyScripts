...
Ensure the R1 is advertising the 192.168.2.0 network in router ospf 50

Initially the VM route table will look like this, 
...
Do this in the VM from root terminal
route del default
route add default gw 192.168.2.101 dev eth1
