...
''' Instructions to Setup MqSQL DB
...
create table CPUUtilization (NetworkCPUUtilizationPercent FLOAT(6,2), Top3CPUDevices VARCHAR(50), PollTimestamp VARCHAR(30));
create table ProcMemUtilization (NetworkProcMemUtilizationPercent FLOAT(6,2), Top3ProcMemDevices VARCHAR(50), PollTimestamp VARCHAR(30));
create table IOMemUtilization (NetworkIOMemUtilizationPercent FLOAT(6,2), Top3IOMemDevices VARCHAR(50), PollTimestamp VARCHAR(30));
create table UPEthInterfaces (NetworkUPEthIntfPercent FLOAT(6,2), Top3UPEthIntf VARCHAR(50), PollTimestamp VARCHAR(30));

show tables;
- Show the table structure
describe NetworkDevices;

-- Create a manual entry into the NetworkDevices
insert into NetworkDevices(Hostname,MACAddr,Vendor,Model,Image,IOSVersion,SerialNo,Uptime,CPUModel,CPUSpeed,SerialIntfNo,CiscoNeighbors,IntRoutingPro,ExtRoutingPro) values('R1','0000.abcd.eeff','Cisco','2691','cisco2691','12.4','abc123456',2000,'ciscoCpu','512',4,'R2,R3','OSPF','BGP');
...
delete from CPUUtilization;
delete from IOMemUtilization;
delete from ProcMemUtilization;
delete from UPEthInterfaces;
